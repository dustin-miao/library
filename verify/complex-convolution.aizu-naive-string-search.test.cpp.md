...
data:
  ...
  bundledCode: "#line 1 \"verify/complex-convolution.aizu-naive-string-search.test.cpp\"\
    ...
    \t\treturn ret;\n\t}\n}\n\n#pragma endregion complex_convolution\n#line 7 \"verify/complex-convolution.aizu-naive-string-search.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_14_A\"\
  ...
  verifiedWith: []
documentation_of: verify/complex-convolution.aizu-naive-string-search.test.cpp
layout: document
redirect_from:
- /verify/verify/complex-convolution.aizu-naive-string-search.test.cpp
- /verify/verify/complex-convolution.aizu-naive-string-search.test.cpp.html
